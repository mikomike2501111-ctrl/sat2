  ...
  return (
    ...
    >
      <div className="aspect-square bg-gray-100 overflow-hidden relative">
        ...
        {isHovering && (
          <div className="absolute inset-0 bg-black/60 animate-fade-in flex flex-col items-center justify-center p-4">
            <div className="text-white text-center space-y-4">
              <div className="space-y-2">
                <p className="text-lg line-through text-gray-300">KSh {product.price.toLocaleString()}</p>
                <p className="text-3xl font-bold text-white">KSh {discountedPrice.toLocaleString()}</p>
              </div>
              <button
                onClick={handleAddToCart}
                disabled={!product.in_stock || isAddingToCart}
                className="w-full py-3 bg-white text-black font-medium rounded hover:bg-gray-100 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
